...
public class DataParser implements Serializable {
    ...
    public DataParser(String theName, String theVicinity, String theLat, String theLng, double theRating) {
        mName = theName;
        ...
        try {
            ...
            if (jsonArray != null) {
                for (int i = 0; i < length; i++) {
                    ...
                    DataParser gas = new DataParser(name, address, lat, lng, rating);
